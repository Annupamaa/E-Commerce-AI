...
## Project Description
Build a personalized recommendation engine using AI to suggest products based on user preferences, browsing behavior, and purchase history. Integrate with the MERN stack to offer real-time recommendations in the shopping cart and product details pages.
